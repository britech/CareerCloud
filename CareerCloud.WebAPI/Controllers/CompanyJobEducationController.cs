...
public class CompanyJobEducationController : IPocoCrudController<CompanyJobEducationPoco>
{
    ...
    public CompanyJobEducationController(BaseLogic<CompanyJobEducationPoco> service) : base(service)
    {
    }

    public CompanyJobEducationController()
        : this(new CompanyJobEducationLogic(new EFGenericRepository<CompanyJobEducationPoco>(EFRepositoryFactory.Default.Instance)))
    {
