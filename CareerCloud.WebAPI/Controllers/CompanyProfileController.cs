...
public class CompanyProfileController : IPocoCrudController<CompanyProfilePoco>
{
    ...
    public CompanyProfileController(BaseLogic<CompanyProfilePoco> service) : base(service)
    {
    }

    public CompanyProfileController()
        : this(new CompanyProfileLogic(new EFGenericRepository<CompanyProfilePoco>(EFRepositoryFactory.Default.Instance)))
    {
