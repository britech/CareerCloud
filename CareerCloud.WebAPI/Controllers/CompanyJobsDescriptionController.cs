...
public class CompanyJobsDescriptionController : IPocoCrudController<CompanyJobDescriptionPoco>
{
    ...
    public CompanyJobsDescriptionController(BaseLogic<CompanyJobDescriptionPoco> service) : base(service)
    {
    }

    public CompanyJobsDescriptionController()
        : this(new CompanyJobDescriptionLogic(new EFGenericRepository<CompanyJobDescriptionPoco>(EFRepositoryFactory.Default.Instance)))
    {
