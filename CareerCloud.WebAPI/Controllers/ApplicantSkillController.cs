...
public class ApplicantSkillController : IPocoCrudController<ApplicantSkillPoco>
{
    ...
    public ApplicantSkillController(BaseLogic<ApplicantSkillPoco> service) : base(service)
    {
    }

    public ApplicantSkillController()
        : this(new ApplicantSkillLogic(new EFGenericRepository<ApplicantSkillPoco>(EFRepositoryFactory.Default.Instance)))
    {
